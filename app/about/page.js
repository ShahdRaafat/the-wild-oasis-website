...
export default function Page() {
  return (
    <div className="space-y-16 md:space-y-20 lg:space-y-24">
      ...
      <div className="grid grid-cols-1 md:grid-cols-5 gap-8 md:gap-16 xl:gap-24 text-base sm:text-md items-center">
        <div className="md:col-span-3 order-2 md:order-1">
          <h1 className="text-2xl sm:text-3xl md:text-4xl mb-6 sm:mb-8 md:mb-10 text-accent-400 font-medium">
        ...
        <div className="md:col-span-3 order-2">
          ...
          <div className="space-y-4 sm:space-y-6 md:space-y-8">
            ...
            <div className="pt-2 sm:pt-4">
              <Link
                href="/cabins"
                className="inline-block bg-accent-500 px-6 sm:px-8 py-4 sm:py-5 text-primary-800 text-base sm:text-md font-semibold hover:bg-accent-600 transition-all rounded-md"
              >
